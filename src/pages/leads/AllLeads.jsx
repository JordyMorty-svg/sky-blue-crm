...
export default function AllLeads() {
  ...
  return (
    <div className="allleads">
      ...
      {/* Same as the pipeline view: the switcher is the heading, the h1
          is kept for assistive tech only. */}
      <h1 className="visually-hidden">All leads</h1>
      <p className="allleads__sub">
        <span className="allleads__total">{leads.length} total</span>
        Every lead ever created, including the scheduled, completed and
